...
public class BitDeListen implements MyCommandListener{
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(str2.trim().equals("输入16位二进制明文/密文")) {
        	String encryptedText1 = SimplifiedAESDecrypt.decryptASCII(str3, str1);
        	output.setText("");
        	output.append("ASCII解密结果为: " + encryptedText1 + "\n");
        }
        else {
        	if(str3.trim().equals("输入明文/密文")) {
        		String encryptedText = SimplifiedAESDecrypt.decryptText(str2, str1);
            	output.setText("");
            	output.append("16bit解密结果为: " + encryptedText + "\n");
            }
        	else {
        		if (!isBitInputValid) {
