...
public class multDeListen implements MyCommandListener{
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(str3.trim().equals("输入4位16进制密钥作为key3")) {
        	String doudecryptedText = MultipleDecryption.doubleDecrypt(str4, str1,str2);
        	output.setText("");
    		output.append("16bit双重解密结果为: " + doudecryptedText + "\n");
        }
        else {
        	if (!isBitKeyValid3) {
        	...
        	String tridecryptedText = MultipleDecryption.tripleDecrypt(str4, str1,str2,str3);
        	output.setText("");
        	output.append("16bit三重解密结果为: " + tridecryptedText + "\n");
        }
